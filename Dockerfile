...
ENV NEXT_PUBLIC_GOOGLE_CLOUD_PROJECT_ID=$GCS_PROJECT_BUILD
...
ENV NEXT_PUBLIC_GOOGLE_CLOUD_AUTH_KEY=
ENV NEXT_PUBLIC_GOOGLE_CLOUD_AUTH_DOMAIN=
ENV NEXT_PUBLIC_GOOGLE_CLOUD_PROJECT_ID=
