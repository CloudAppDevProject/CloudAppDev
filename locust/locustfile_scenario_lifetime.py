...
from locust import LoadTestShape as BaseLoadTestShape
...
class LoadTestShape(BaseLoadTestShape):
    """
    ...
    Growth rate: Configurable users per minute (default: 120 users/minute = 2 users/second)
    Max duration: 30 minutes (will reach ~3610 users with default rate, capped at 3500)
    Max users: Safety limit at 3500 users
    ...
    - GROWTH_RATE: users per minute (e.g., "60" for slower, "180" for faster)
    - MAX_DURATION: test duration in seconds (e.g., "600" for 10 min, "3600" for 60 min)
    - MAX_USERS: safety limit (e.g., "5000" to increase beyond 3500)
    """
...
# LIFETIME: Continuous growth scenario (LoadTestShape class defined above)
...
def on_test_start(environment, **kwargs):
    ...
    shape_name = "Once-in-a-Lifetime Workload (continuous growth)"
...
def on_test_stop(environment, **kwargs):
    ...
    # Threshold Analysis for Once-in-a-Lifetime scenario
